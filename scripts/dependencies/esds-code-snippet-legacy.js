...
function (_Slotify) {
  ...
  _createClass(EsdsCodeSnippet, null, [{
    ...
    key: "DEFAULT_LANGUAGE_TAB_LABELS",
    get: function get() {
      return {
        html: 'HTML',
        vue: 'Vue',
  ...
  function EsdsCodeSnippet() {
    ...
    _this.defaultClass = 'esds-code-snippet';
    ...
    _this.copyable = 'true';
    _this.source = ''; // Set up tabbed interface
  ...
  _createClass(EsdsCodeSnippet, [{
    ...
    key: "formatSource",
    value: function formatSource(source, language, preformatted) {
      ...
      var beautifiedSource = preformatted ? source : this.beautifySource(source, language);
      return this.highlightSource(beautifiedSource, language);
    }
  }, {
    key: "handleSlotSourceChange",
    value: function handleSlotSourceChange(e) {
      // See if the default slot contains anything
      var assignedContent = e.target.querySelector('s-assigned-wrapper');
    ...
    value: function linkPanels() {
      ...
      this.sources.forEach(function (sourceObject) {
        ...
        var tabLabel = sourceObject.tabLabel ? sourceObject.tabLabel : _this2.constructor.DEFAULT_LANGUAGE_TAB_LABELS[sourceObject.language.toLowerCase()];

        _this2.tabs.push(html$2(_templateObject(), _this2.handleTabClick, sourceObject.selectedTab ? ' esds-code-snippet__tab--selected' : '', tabId, tabPanelId, tabLabel));
    ...
    value: function renderCodeSnippet(sourceObject) {
      ...
      var preformatted = sourceObject.preformatted;
      var source = this.formatSource(stripIndent(this.cleanShadyDomRenderingArtifacts(this.cleanLitElementRenderingArtifacts(this.cleanVueRenderingArtifacts(sourceObject.source)))), language, preformatted);
    ...
    value: function renderCopyButton() {
      ...
      if (this.constructor.copyButton) {
        ...
        copyButton = html$2(_templateObject5(), unsafeHTML(this.constructor.copyButton));
      }

      if (this.copyable === 'true') {
        return html$2(_templateObject6(), this.codeCopiedText, this.copyCodeToClipboard, copyButton);
      } else {
        return '';
      }
    }
    ...
    value: function renderToolbar() {
      var toolbarActions = [];
      var output = '';
      var tabset = this.tabs.length > 1 ? html$2(_templateObject7(), this.tabs) : '';
      ...
      if (toolbarActions.length > 0) {
        output = html$2(_templateObject8(), tabset, toolbarActions);
      }
    ...
    value: function render() {
      ...
      if (this.sources && this.sources.length > 1) {
        this.linkPanels();
        sourceOutput = html$2(_templateObject9(), this.tabPanels);
      } else {
      ...
      return html$2(_templateObject10(), blockLevelClass, this.renderToolbar(), this.handleSlotSourceChange, sourceOutput);
    }
  }, {
    key: "allTabPanels",
    get: function get() {
